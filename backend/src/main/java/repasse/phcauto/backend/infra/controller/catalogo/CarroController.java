...
@RestController
@RequestMapping("/api/v1/catalogo/carros")
@Tag(name = "Carro")
public class CarroController {
    private final CrudHttpResponseFactory responses;

    public CarroController(CrudHttpResponseFactory responses) {
    ...
    public ResponseEntity<HashMap<String, Object>> cadastrar(
        ...
        return responses.criado("Carro cadastrado com sucesso.", body);
    }

    @GetMapping("/{veiculoId}")
    public ResponseEntity<HashMap<String, Object>> buscar(@PathVariable UUID veiculoId) {
        return responses.sucesso("Carro consultado com sucesso.", responses.identificador("veiculoId", veiculoId));
    }
    ...
    public ResponseEntity<HashMap<String, Object>> listar(
        ...
        return responses.sucesso("Carros listados com sucesso.", responses.pagina(offset, limite));
    }

    @PutMapping("/{veiculoId}")
    public ResponseEntity<HashMap<String, Object>> editar(@PathVariable UUID veiculoId,
            @RequestBody HashMap<String, Object> body) {
        return responses.sucesso("Carro editado com sucesso.", body);
    }

    @DeleteMapping("/{veiculoId}")
    public ResponseEntity<HashMap<String, Object>> deletar(@PathVariable UUID veiculoId) {
        return responses.sucesso("Carro deletado com sucesso.", responses.identificador("veiculoId", veiculoId));
    }
}
