...
@RestController
@RequestMapping("/api/v1/identidade/usuarios-pf")
@Tag(name = "Perfil de pessoa física")
public class UsuarioPfController {
    private final CrudHttpResponseFactory responses;

    public UsuarioPfController(CrudHttpResponseFactory responses) {
    ...
    public ResponseEntity<HashMap<String, Object>> cadastrar(
        ...
        return responses.criado("Perfil de pessoa física cadastrado com sucesso.", body);
    }

    @GetMapping("/{usuarioId}")
    public ResponseEntity<HashMap<String, Object>> buscar(@PathVariable UUID usuarioId) {
        return responses.sucesso("Perfil de pessoa física consultado com sucesso.", responses.identificador("usuarioId", usuarioId));
    }
    ...
    public ResponseEntity<HashMap<String, Object>> listar(
        ...
        return responses.sucesso("Perfis de pessoa física listados com sucesso.", responses.pagina(offset, limite));
    }

    @PutMapping("/{usuarioId}")
    public ResponseEntity<HashMap<String, Object>> editar(@PathVariable UUID usuarioId,
            @RequestBody HashMap<String, Object> body) {
        return responses.sucesso("Perfil de pessoa física editado com sucesso.", body);
    }

    @DeleteMapping("/{usuarioId}")
    public ResponseEntity<HashMap<String, Object>> deletar(@PathVariable UUID usuarioId) {
        return responses.sucesso("Perfil de pessoa física deletado com sucesso.", responses.identificador("usuarioId", usuarioId));
    }
}
