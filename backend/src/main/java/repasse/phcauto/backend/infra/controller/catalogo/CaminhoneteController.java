...
@RestController
@RequestMapping("/api/v1/catalogo/caminhonetes")
@Tag(name = "Caminhonete")
public class CaminhoneteController {
    private final CrudHttpResponseFactory responses;

    public CaminhoneteController(CrudHttpResponseFactory responses) {
    ...
    public ResponseEntity<HashMap<String, Object>> cadastrar(
        ...
        return responses.criado("Caminhonete cadastrada com sucesso.", body);
    }

    @GetMapping("/{veiculoId}")
    public ResponseEntity<HashMap<String, Object>> buscar(@PathVariable UUID veiculoId) {
        return responses.sucesso("Caminhonete consultada com sucesso.", responses.identificador("veiculoId", veiculoId));
    }
    ...
    public ResponseEntity<HashMap<String, Object>> listar(
        ...
        return responses.sucesso("Caminhonetes listadas com sucesso.", responses.pagina(offset, limite));
    }

    @PutMapping("/{veiculoId}")
    public ResponseEntity<HashMap<String, Object>> editar(@PathVariable UUID veiculoId,
            @RequestBody HashMap<String, Object> body) {
        return responses.sucesso("Caminhonete editada com sucesso.", body);
    }

    @DeleteMapping("/{veiculoId}")
    public ResponseEntity<HashMap<String, Object>> deletar(@PathVariable UUID veiculoId) {
        return responses.sucesso("Caminhonete deletada com sucesso.", responses.identificador("veiculoId", veiculoId));
    }
}
