...
@Hidden
@RestController
@RequestMapping("/api/v1/catalogo/anuncios")
@Tag(name = "Anúncio")
public class AnuncioController {
    private final CrudHttpResponseFactory responses;

    public AnuncioController(CrudHttpResponseFactory responses) {
    ...
    public ResponseEntity<HashMap<String, Object>> cadastrar(
        ...
        return responses.criado("Anúncio cadastrado com sucesso.", body);
    }

    @GetMapping("/{id}")
    public ResponseEntity<HashMap<String, Object>> buscar(@PathVariable UUID id) {
        return responses.sucesso("Anúncio consultado com sucesso.", responses.identificador("id", id));
    }
    ...
    public ResponseEntity<HashMap<String, Object>> listar(
        ...
        return responses.sucesso("Anúncios listados com sucesso.", responses.pagina(offset, limite));
    }

    @PutMapping("/{id}")
    public ResponseEntity<HashMap<String, Object>> editar(@PathVariable UUID id,
            @RequestBody HashMap<String, Object> body) {
        return responses.sucesso("Anúncio editado com sucesso.", body);
    }

    @DeleteMapping("/{id}")
    public ResponseEntity<HashMap<String, Object>> deletar(@PathVariable UUID id) {
        return responses.sucesso("Anúncio deletado com sucesso.", responses.identificador("id", id));
    }
}
