...
@RestController
@RequestMapping("/api/v1/identidade/enderecos")
@Tag(name = "Endereço do usuário")
public class EnderecoUsuarioController {
    private final CrudHttpResponseFactory responses;

    public EnderecoUsuarioController(CrudHttpResponseFactory responses) {
    ...
    public ResponseEntity<HashMap<String, Object>> cadastrar(
        ...
        return responses.criado("Endereço do usuário cadastrado com sucesso.", body);
    }

    @GetMapping("/{usuarioId}")
    public ResponseEntity<HashMap<String, Object>> buscar(@PathVariable UUID usuarioId) {
        return responses.sucesso("Endereço do usuário consultado com sucesso.", responses.identificador("usuarioId", usuarioId));
    }
    ...
    public ResponseEntity<HashMap<String, Object>> listar(
        ...
        return responses.sucesso("Endereços dos usuários listados com sucesso.", responses.pagina(offset, limite));
    }

    @PutMapping("/{usuarioId}")
    public ResponseEntity<HashMap<String, Object>> editar(@PathVariable UUID usuarioId,
            @RequestBody HashMap<String, Object> body) {
        return responses.sucesso("Endereço do usuário editado com sucesso.", body);
    }

    @DeleteMapping("/{usuarioId}")
    public ResponseEntity<HashMap<String, Object>> deletar(@PathVariable UUID usuarioId) {
        return responses.sucesso("Endereço do usuário deletado com sucesso.", responses.identificador("usuarioId", usuarioId));
    }
}
